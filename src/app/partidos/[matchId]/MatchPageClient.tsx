...
function BoxScoreTable({ teamStats, teamColor, players }: BoxScoreTableProps) {
      ...
      {match.isPlayed && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-8)' }}>
          <div className="section animate-fade-in-up delay-1">
            ...
            <BoxScoreTable teamStats={homeStats} teamColor={homeTeam.primaryColor} players={players} />
          </div>
          ...
          <div className="section animate-fade-in-up delay-2">
            ...
            <BoxScoreTable teamStats={awayStats} teamColor={awayTeam.primaryColor} players={players} />
          </div>
        </div>
      )}
    </div>
